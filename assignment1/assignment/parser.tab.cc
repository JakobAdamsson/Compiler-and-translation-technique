...
#line 213 "parser.yy"
            {
              yylhs.value.as < Node * > () = new Node("ParenExp", "", yylineno);
              yylhs.value.as < Node * > ()->children.push_back(yystack_[1].value.as < Node * > ());
            }
...
#undef YYCASE_
  ...
  parser::yyrline_[] =
  {
       0,    56,    56,    61,    65,    71,    75,    79,    83,    87,
      93,    97,   103,   109,   115,   121,   127,   134,   140,   146,
     152,   158,   165,   174,   178,   182,   186,   190,   194,   201,
     207,   212,   217,   226,   233,   238,   244,   249,   256,   263,
     272,   288,   298,   302,   306,   316,   320,   330,   334,   338,
     348,   352,   358,   370,   374,   378,   382,   388,   400,   404,
     412,   416,   426,   430
  };
