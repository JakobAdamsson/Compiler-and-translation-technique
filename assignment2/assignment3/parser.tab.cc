...
#line 78 "parser.yy"
            {
              yylhs.value.as < Node * > () = new Node("Boolean", "", yylineno,"Boole");
            }
...
#line 186 "parser.yy"
            {
              yylhs.value.as < Node * > () = new Node("True", "", yylineno, "Boolean");
            }
...
#line 190 "parser.yy"
            {
              yylhs.value.as < Node * > () = new Node("False", "", yylineno, "Boolean");
            }
...
#undef YYCASE_
  ...
  parser::yyrline_[] =
  {
     ...
     101,   105,   113,   119,   125,   131,   137,   143,   150,   156,
     162,   168,   174,   181,   185,   189,   193,   198,   202,   209,
     215,   220,   224,   228,   237,   244,   249,   255,   260,   267,
     274,   288,   304,   332,   337,   347,   351,   357,   367,   371,
     378,   384,   388,   393,   403,   407,   412,   419,   425,   438,
     443,   451,   455,   465,   469
  };
