...
#line 627 "parser.tab.cc"
  ...
  case 7: // factor: INT
#line 58 "parser.yy"
                          {  yylhs.value.as < Node * > () = new Node("Int", yystack_[0].value.as < std::string > ()); /* printf("r5 ");  Here we create a leaf node Int. The value of the leaf node is $1 */}
